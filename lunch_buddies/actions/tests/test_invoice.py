...
from lunch_buddies.actions.tests.fixtures import dynamo_team, dynamo_poll, team, dynamo_poll_response, poll
...
def test_get_polls_needing_invoice(mocker):
    ...
    assert [p.callback_id for p in result] == [UUID('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3')]
