...
def test_sqs_handler_failure(mocker):
    ...
    mocker.patch.object(module, 'create_poll_action', auto_spec=True, side_effect=Exception('test failure message'))
    ...
    service_context.clients.sqs_v2.set_visibility_timeout_with_backoff.assert_called_with(test_output[0])
