...
class DynamoClient:
    ...
    def read(self, table_name: str, key: Optional[str], value: Optional[DynamoValue]) -> Optional[List[DynamoObject]]:
        if not self.dynamo:
            return None
    ...
    def update(self, table_name: str, key: DynamoObject, column: str, new_value: DynamoValue) -> None:
        if not self.dynamo:
            return None
